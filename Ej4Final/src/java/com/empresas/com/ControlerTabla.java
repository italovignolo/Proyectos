...
public class ControlerTabla {
        private int N; 
    private String Nombre; private int a2005; private int a2006; private int a2007; private int a2008; private int a2009; 
    ...
    public ControlerTabla(int N, String Nombre, int a2005, int a2006, int a2007, int a2008, int a2009, int a2010, int a2011, int a2012, int a2013, int a2014, int a2015){
        this.N = N;
        this.Nombre = Nombre;
        this.a2005 = a2005;
        this.a2006 = a2006;
